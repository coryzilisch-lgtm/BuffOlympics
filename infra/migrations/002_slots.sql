...
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('unity-circle', N'Unity Circle', NULL, 0, NULL, N'Walk up anytime', NULL, 0, NULL, NULL, NULL, NULL, 1, 13);
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('totem-tower', N'Totem Tower', NULL, 0, NULL, N'Walk up anytime', NULL, 0, NULL, NULL, NULL, NULL, 1, 14);
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('hook-ring', N'Hook & Ring', NULL, 0, NULL, N'Walk up anytime', NULL, 0, NULL, NULL, NULL, NULL, 1, 15);
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('name-that-song', N'Name that Song', NULL, 0, NULL, N'Walk up anytime', NULL, 0, NULL, NULL, NULL, NULL, 1, 16);
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('suck-it-up', N'Suck it up', NULL, 0, NULL, N'Walk up anytime', NULL, 0, NULL, NULL, NULL, NULL, 1, 17);
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('state-of-affairs', N'state of affairs', NULL, 0, NULL, N'Walk up anytime', NULL, 0, NULL, NULL, NULL, NULL, 1, 18);
...
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('alliance-lift', N'Alliance Lift', NULL, 0, NULL, N'Walk up anytime', NULL, 0, NULL, NULL, NULL, NULL, 1, 23);
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('firekeepers-puzzle', N'Firekeepers Puzzle', NULL, 0, NULL, N'Walk up anytime', NULL, 0, NULL, NULL, NULL, NULL, 1, 24);
...
INSERT INTO dbo.bo_games (id, name, block, cap, players, time_label, points_label, needs_ref, venue, descr, inventory, video_url, open_play, sort) VALUES ('what-s-lurking', N'What''s Lurking?', NULL, 0, NULL, N'2:45 PM – 3:25 PM', NULL, 0, NULL, NULL, NULL, NULL, 0, 26);
